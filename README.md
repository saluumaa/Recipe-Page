...
> This project is built with HTML and CSS , it is a recipe page challenge from frontendmentor.io
...
```sh
  ...
  git clone https://github.com/saluumaa/Recipe-Page
```
...
Feel free to check the [issues page](https://github.com/saluumaa/Recipe-Page/issues).
